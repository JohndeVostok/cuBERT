...
//     Att_Q_K<float> bqk(handle, 2, seq_length, num_attention_heads,
//     size_per_head, query_gpu, key_gpu, out_gpu);
...
//     Att_QK_V<float> bqkv(handle, 2, seq_length, num_attention_heads,
//     size_per_head, qk_gpu, value_gpu, out_gpu);

...
//     BertEmbeddings<float> bert_embeddings(handle, var, 32, vocab_size,
//     type_vocab_size, hidden_size, seq_length);
...
//     bert_embeddings.compute(batch_size, input_ids_gpu, segment_ids_gpu,
//     out_gpu);
